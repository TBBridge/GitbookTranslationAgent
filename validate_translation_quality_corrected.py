#!/usr/bin/env python3
"""
Translation Quality Validation Script - Corrected Version
...
"""
    ...
    def validate_overall_quality(self, original: str, translated: str, language: str) -> Dict[str, Any]:
        ...
        if japanese_chars:
            # Filter out acceptable Japanese (like in anchor links)
            problematic_japanese = [char for char in japanese_chars if len(char) > 1]
